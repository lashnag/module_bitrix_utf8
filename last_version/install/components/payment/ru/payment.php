...
$MESS["PLATRON_ERROR_TRY_LATER"]="К сожалению, в системе <em>Platron</em> не удалось создать счёт на оплату вашего заказа. Попробуйте повторить оплату позже из персонального раздела.";
$MESS["PLATRON_PAY_BUTTON"]="Перейти к оплате";
